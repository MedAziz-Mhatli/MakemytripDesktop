...
import voyage.services.ServiceChauffeur;
import voyage.services.ServiceVoiture;
import com.jfoenix.controls.JFXTextArea;
import com.jfoenix.controls.JFXTextField;
import de.jensd.fx.glyphs.fontawesome.FontAwesomeIconView;
import voyage.utils.javaMail;
...
public class PlateformeUI implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        List<chauffeur> lss=new ArrayList<>();
        ...
        try {
            ...
            try {
                for (int i = 0; i < ls.size(); i++) {
                    ...
                    voyage.gui.ItemControllor itemControllor = fxmlLoader.getController();
                ...
                for(int j=0;j<lss.size();j++){
                    ...
                    HBox cardBox = fxmlLoader.load();
                    voyage.gui.item2controllor itemControllor = fxmlLoader.getController();
    ...
    public void btnHome (ActionEvent event) {
        playMusic("C:\\Users\\DELL\\Downloads\\spring\\web_project\\SpringBoot4DS2\\CAR\\src\\resources\\Sound.wav");
