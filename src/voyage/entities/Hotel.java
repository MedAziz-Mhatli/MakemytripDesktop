...
public class Hotel {
  private int id_hotel;
    ...
    public Hotel(String nom, String description, String adresse, String categorie, int nb_chDispo, String email, int telephone) {
        this.nom = nom;
        this.description = description;
        this.adresse = adresse;
        this.categorie = categorie;
    ...
    public Hotel(String description, String adresse, String categorie, int nb_chDispo, String email, int telephone) {
        this.description = description;
        this.adresse = adresse;
        this.categorie = categorie;
        this.nb_chDispo = nb_chDispo;
