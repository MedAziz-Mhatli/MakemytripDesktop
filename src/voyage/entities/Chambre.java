...
public class Chambre {
  ...
  private voyage.entities.Type.Types type;
  private Vue.Veus vue;
  private Double prix_nuitee;
  private int id_hotel;

    public Chambre(int id_chambre, voyage.entities.Type.Types type, Vue.Veus vue, Double prix_nuitee, int id_hotel) {
...
public Chambre() {
    ...
    public voyage.entities.Type.Types getType() {
        return type;
    }
    ...
    public void setType(voyage.entities.Type.Types type) {
        this.type = type;
    }
